import {
  ...
  p,
  zwitch
} from "./chunk-AADDOKXN.js";
import "./chunk-FAZOTWSJ.js";
import "./chunk-K3KPUXIC.js";
import {
  find,
  html,
  stringify,
  ...
  svg,
  whitespace
} from "./chunk-EHMDFZK6.js";
import "./chunk-4JENWNM6.js";
...
// node_modules/streamdown/dist/code-block-RYKACFZZ.js
...
var BasicScopeAttributesProvider = (_a = class {
  ...
  _toStandardTokenType(scopeName) {
    const m4 = scopeName.match(_a.STANDARD_TOKEN_TYPE_REGEXP);
    if (!m4) {
      return 8;
    }
    switch (m4[1]) {
...
async function normalizeGetter(p4) {
  return Promise.resolve(typeof p4 === "function" ? p4() : p4).then((r4) => r4.default || r4);
}
...
function transformerDecorations() {
  ...
  function getContext(shiki) {
    if (!map.has(shiki.meta)) {
      let normalizePosition = function(p4) {
        if (typeof p4 === "number") {
          if (p4 < 0 || p4 > shiki.source.length)
            throw new ShikiError(`Invalid decoration offset: ${p4}. Code length: ${shiki.source.length}`);
          return {
            ...converter.indexToPos(p4),
            offset: p4
          };
        } else {
          const line = converter.lines[p4.line];
          if (line === void 0)
            throw new ShikiError(`Invalid decoration position ${JSON.stringify(p4)}. Lines length: ${converter.lines.length}`);
          let character = p4.character;
          if (character < 0)
            character = line.length + character;
          if (character < 0 || character > line.length)
            throw new ShikiError(`Invalid decoration position ${JSON.stringify(p4)}. Line ${p4.line} length: ${line.length}`);
          return {
            ...p4,
            character,
            offset: converter.posToIndex(p4.line, character)
          };
        }
      };
...
async function createOnigurumaEngine(options) {
  ...
  return {
    createScanner(patterns) {
      return new OnigScanner(patterns.map((p4) => typeof p4 === "string" ? p4 : p4.source));
    },
    createString(s2) {
...
function M(e, n = {}) {
  ...
  return { tokens: r4.map((u2) => u2.type === "EscapedNumber" ? ee(u2, g2) : u2).flat(), flags: o3 };
}
function F(e, n, t, o3) {
  const [s2, a2] = t;
  if (t === "[" || t === "[^") {
...
`, o3);
  ...
  return t === "|" ? { token: P2(t) } : y.test(t) ? { tokens: te(t) } : { token: d(r(t), t) };
}
function K(e, n, t) {
  const o3 = [E(n[1] === "^", n)];
  let s2 = 1, a2;
...
function J2(e, r4 = {}) {
  const n = { flags: "", normalizeUnknownPropertyNames: false, skipBackrefValidation: false, skipLookbehindValidation: false, skipPropertyNameValidation: false, unicodePropertyMap: null, ...r4, rules: { captureGroup: false, singleline: false, ...r4.rules } }, t = M(e, { flags: n.flags, rules: { captureGroup: n.rules.captureGroup, singleline: n.rules.singleline } }), s2 = (p4, N) => {
    const u2 = t.tokens[o3.nextIndex];
    switch (o3.parent = p4, o3.nextIndex++, u2.type) {
      case "Alternator":
        return b2();
      case "Assertion":
        return W2(u2);
  ...
  for (; o3.nextIndex < t.tokens.length; ) {
    const p4 = s2(d2, {});
    p4.type === "Alternative" ? (i2.body.push(p4), d2 = p4) : d2.body.push(p4);
  }
  ...
  for (const { ref: p4 } of f3) if (typeof p4 == "number") {
    if (p4 > a2.length) throw new Error("Subroutine uses a group number that's not defined");
    p4 && (a2[p4 - 1].isSubroutined = true);
  } else if (c.has(p4)) {
    if (c.get(p4).length > 1) throw new Error(o`Subroutine uses a duplicate group name "\g<${p4}>"`);
    c.get(p4)[0].isSubroutined = true;
  } else throw new Error(o`Subroutine uses a group name that's not defined "\g<${p4}>"`);
  return i2;
}
function W2({ kind: e }) {
...
function te2(e, r4, n) {
  ...
  let p4 = D2(t[r4.nextIndex]);
  for (; p4.type !== "GroupClose"; ) {
    if (p4.type === "Alternator") a2.body.push(b2()), r4.nextIndex++;
    else {
      ...
      if (N.body.push(u2), (c || n.isInLookbehind) && !i2) {
        ...
        if (f3 || n.isInNegLookbehind) {
          if (M2(u2) || u2.type === "CapturingGroup") throw new Error(v3);
        } else if (M2(u2) || $2(u2) && u2.negate) throw new Error(v3);
      }
    }
    p4 = D2(t[r4.nextIndex]);
  }
...
function S(a2, v3, N = null) {
  ...
  function n(e, s2 = null, t = null, r4 = null) {
    ...
    const d2 = { node: e, parent: s2, key: t, container: r4, root: a2, remove() {
      ...
      const b4 = !!y3.traverse;
      r4 ? r4[Math.max(0, l2(t) + i2)] = o3 : u(s2, "Can't replace root node")[t] = o3, b4 && n(o3, s2, t, r4), c = true;
      ...
      c = true;
    } }, { type: m4 } = e, h3 = v3["*"], p4 = v3[m4], R3 = typeof h3 == "function" ? h3 : h3 == null ? void 0 : h3.enter, P4 = typeof p4 == "function" ? p4 : p4 == null ? void 0 : p4.enter;
    if (R3 == null ? void 0 : R3(d2, N), P4 == null ? void 0 : P4(d2, N), !c) switch (m4) {
    ...
    return (_a4 = p4 == null ? void 0 : p4.exit) == null ? void 0 : _a4.call(p4, d2, N), (_b = h3 == null ? void 0 : h3.exit) == null ? void 0 : _b.call(h3, d2, N), i2;
  }
  return n(a2), a2;
}
function f2(a2) {
...
White_Space space
XID_Continue XIDC
XID_Start XIDS`.split(/\s/).map((p4) => [w2(p4), p4])
);
...
var JavaScriptScanner = class {
  constructor(patterns, options = {}) {
    ...
    this.regexps = patterns.map((p4) => {
      if (typeof p4 !== "string") {
        return p4;
      }
      const cached = cache == null ? void 0 : cache.get(p4);
      if (cached) {
      ...
      try {
        const regex = regexConstructor(p4);
        cache == null ? void 0 : cache.set(p4, regex);
        return regex;
      } catch (e) {
        cache == null ? void 0 : cache.set(p4, e);
        if (forgiving)
          return null;
        throw e;
      }
...
// node_modules/streamdown/dist/code-block-RYKACFZZ.js
var v2 = p("block", "before:content-[counter(line)]", "before:inline-block", "before:[counter-increment:line]", "before:w-4", "before:mr-4", "before:text-[13px]", "before:text-right", "before:text-muted-foreground/50", "before:font-mono", "before:select-none");
...
var h2 = (e, t, o3, r4) => {
  ...
  return p3.has(n) ? p3.get(n) : (r4 && (g.has(n) || g.set(n, /* @__PURE__ */ new Set()), g.get(n).add(r4)), K3(s2, o3).then((l3) => {
...
var ie2 = ({ code: e, language: t, className: o3, children: r4, ...s2 }) => {
  let { shikiTheme: n } = (0, import_react.useContext)(P), l3 = (0, import_react.useMemo)(() => ({ bg: "transparent", fg: "inherit", tokens: e.split(`
`).map((i2) => [{ content: i2, color: "inherit", bgColor: "transparent", htmlStyle: {}, offset: 0 }]) }), [e]), [d2, a2] = (0, import_react.useState)(l3);
  ...
  }, [e, t, n]), (0, import_jsx_runtime.jsx)(Rn.Provider, { value: { code: e }, children: (0, import_jsx_runtime.jsxs)(C3, { language: t, children: [(0, import_jsx_runtime.jsx)(L3, { language: t, children: r4 }), (0, import_jsx_runtime.jsx)(b3, { className: o3, language: t, result: d2, ...s2 })] }) });
};
export {
  ie2 as CodeBlock
};
//# sourceMappingURL=code-block-RYKACFZZ-UMVEXKGJ.js.map
