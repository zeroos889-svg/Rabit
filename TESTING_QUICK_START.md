...
```bash
export DATABASE_URL="postgresql://postgres:zPmqVDkPAzLqPsAAiTRfuKJwTStwokyL@switchback.proxy.rlwy.net:39206/railway"
```

### خطوة 2: تشغيل المايغريشن (إنشاء الجداول)
...
✅ Tables discovered: users, consultants, consultationBookings, ...
...
```bash
# اختبار سريع
export DATABASE_URL="mysql://..." && node scripts/test-db-connection.mjs
