...
```
client/public/
├── LOGO.svg              # الشعار الكامل (ثنائي اللغة + الأيقونة)
...
### الألوان
- **تدرج السلسلة:** `#6AD4FF` → `#4F9DFF` → `#1F53FF`
- **تدرج النص:** `#143FCE` → `#092982`
- **الخلفية الفاتحة:** استخدم الشعار الأصلي كما هو
- **الخلفية الداكنة:** أضف Padding أبيض بسيط أو استخدم نسخة مع خلفية فاتحة

### عناصر الشعار
- **الأيقونة:** سلسلتان متداخلتان بسُمك موحد وزوايا دائرية (Stroke = 36px)
- **الكلمة العربية:** خط Tajawal أو Cairo بوزن 600 ومحاذاة baseline مع منتصف الأيقونة
- **الكلمة الإنجليزية:** خط Nunito أو Inter بوزن 700 ومسافة حرفية 1px
